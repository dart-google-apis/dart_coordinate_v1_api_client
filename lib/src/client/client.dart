...
abstract class Client extends ClientBase {
  core.String basePath = "/coordinate/v1/teams/";
  ...
  CustomFieldDefResource_ get customFieldDef => new CustomFieldDefResource_(this);
  JobsResource_ get jobs => new JobsResource_(this);
  LocationResource_ get location => new LocationResource_(this);
  ScheduleResource_ get schedule => new ScheduleResource_(this);
  WorkerResource_ get worker => new WorkerResource_(this);
